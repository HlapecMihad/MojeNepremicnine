        ...
        <div className="filtri container mt-2">
            ...
            <div>
                ...
                >
                    ...
                    <option value="Trgovine in restavracije/pub/gostilne">Trgovine in restavracije/pub/gostilne</option>
                    <option value="Industrijski objekt">Industrijski objekt</option>
                    <option value="Investicijske nepremičnine">Investicijske nepremičnine</option>
            ...
            <div className="range-group">
                <div>
                    <label>Velikost zemljišča m<sup>2</sup>&nbsp; (min - max)</label>
                    <input
                        type="number"
                        placeholder="Min"
                        value={localFilters.velikost_zemljiscaMin || ""}
                        onChange={(e) => handleInputChange(e, "velikost_zemljiscaMin", true)}
                    />
                    <input
                        type="number"
                        placeholder="Max"
                        value={localFilters.velikost_zemljiscaMax || ""}
                        onChange={(e) => handleInputChange(e, "velikost_zemljiscaMax", true)}
                    />
                </div>
            </div>
            <div className="range-group">
                <div>
                    <label>Velikost skupaj m<sup>2</sup>&nbsp; (min - max)</label>
                    <input
                        type="number"
                        placeholder="Min"
            ...
            <div className="button-group" >
               <button className="btn-apply" onClick={onClose}>Zapri</button>
               <button className="btn-apply" onClick={handleClearFilters}>Odstrani filtre</button>
               <button className="btn-apply" onClick={handleApplyClick}>Uporabi filtre</button>
            </div>
        </div>
    );
};
